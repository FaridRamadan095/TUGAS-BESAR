...
public class Inputan{
	...
	public void jalan() {
		...
		kondisi = new JumlahKondisidanPosisiSarana(in.next(), in.next(), in.next());
		...
		bersih = new KebersihanRuangKelas(kondisi.getNamaRuang(), kondisi.getLokasiRuang(), kondisi.getFakultas(), in.next(), in.next(), in.next(), in.next(), in.next());
		...
		keamananan = new KeamananRuangKelas(kondisi.getNamaRuang(), kondisi.getLokasiRuang(), kondisi.getFakultas());
		boolean ulang=false;
		while(ulang==false){
